import pygame
from system.button import ButtonConfig, Button, VolumeSlider
from system.constants import Menu as m, ColorPalette as cp, GameState as gs
