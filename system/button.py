import pygame
from system.image import ButtonSprite
from system.constants import Menu as m, Button as bt, GameState as gs
...
class Button:
    ...
    def __init__(
        ...
        press_image: pygame.Surface | None = None,
        enabled: bool = True,
        action: gs | None = None,
        ...
        self.press_image: pygame.Surface | None = press_image
        ...
        self.shadow_image: pygame.Surface = self.press_image if self.press_image else self.create_hue(offset=-40)
